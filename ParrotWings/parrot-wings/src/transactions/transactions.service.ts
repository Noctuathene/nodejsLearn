...
export class TransactionsService {
    ...
    async create(transactionDto : TransactionDto)
    {
        ...
        getManager().transaction(async transactionalEntityManager => {
            ...
            await transactionalEntityManager.decrement(User, { id: transaction.recipient.id}, 'amount', transaction.amount);
            await transactionalEntityManager.increment(User, { id: transaction.correspondent.id}, 'amount', transaction.amount);
        });
